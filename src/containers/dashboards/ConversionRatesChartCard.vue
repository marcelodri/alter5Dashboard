    ...
    <b-card-body>
      <div class="float-left float-none-xs">
        <div class="d-inline-block">
          <h5 class="d-inline">{{ $t('dashboards.conversion-title') }}</h5>
          <span class="text-muted text-small d-block">{{ $t('dashboards.conversion-tipo') }}</span>
        </div>
      </div>
      <b-dropdown
        id="ddown5"
        :text="$t('dashboards.conversion-serch')"
        size="xs"
