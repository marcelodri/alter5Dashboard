...
const routes = [
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "panelmanager",
            component: () =>
              import(/* webpackChunkName: "dashboards" */ "./views/app/dashboards/PanelManager"),
            // meta: { roles: [UserRole.Editor] },
          },
          {
            path: "logs",
            component: () =>
              import(/* webpackChunkName: "dashboards" */ "./views/app/dashboards/Logs"),
            // meta: { roles: [UserRole.Editor] },
          },
          {
            path: "proyectos",
            component: () =>
              import(/* webpackChunkName: "dashboards" */ "./views/app/dashboards/Proyectos"),
            // meta: { roles: [UserRole.Editor] },
          },
          {
            path: "promotor",
            component: () =>
              import(/* webpackChunkName: "dashboards" */ "./views/app/dashboards/Promotor"),
            // meta: { roles: [UserRole.Editor] },
          }
        ]
      },
  ...
  },
  {
    path: "*",
    //component: () => import(/* webpackChunkName: "error" */ "./views/Error");
    redirect: process.env.BASE_URL+`${adminRoot}/dashboards/default`,
  }
];
