import { adminRoot, rutaImage } from "./config";
//import { UserRole } from "../utils/auth.roles";

const data = [{
  id: "dashboards",
  icon: rutaImage+"/assets/img/buttons/proyectos/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/proyectos/active.svg",
  ...
  {
    icon: "simple-icon-doc",
    label: "menu.panel_manager",
    to: `${adminRoot}/dashboards/panelmanager`,
    // roles: [UserRole.Editor],
    image: '../../assets/img/icons/proyectos.svg'
  }
  ,
  {
    icon: "simple-icon-doc",
    label: "Logs",
    to: `${adminRoot}/dashboards/logs`,
    // roles: [UserRole.Editor],
  },
  {
    icon: "simple-icon-doc",
    label: "menu.proyectos",
    to: `${adminRoot}/dashboards/proyectos`,
    // roles: [UserRole.Editor],
    image: '../../assets/img/icons/proyectos.svg'
  },
  {
  ...
  {
    icon: "simple-icon-doc",
    label: "Panel Promotor",
    to: `${adminRoot}/dashboards/promotor`,
    // roles: [UserRole.Admin],
  }
...
{
  id: "pages",
  icon: rutaImage+"/assets/img/buttons/usuarios/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/usuarios/active.svg",
  label: "Usuarios",
  to: `${adminRoot}/pages`,
  subs: [{
...
{
  id: "applications",
  icon: rutaImage+"/assets/img/buttons/pendientes/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/pendientes/active.svg",
  label: "Aplicaciones",
...
{
  id: "ui",
  icon: rutaImage+"/assets/img/buttons/estatregias/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/estatregias/active.svg",
  label: "Estrategias",
  to: `${adminRoot}/ui`,
  subs: [
    {
...
{
  id: "menu",
  icon: rutaImage+"/assets/img/buttons/inversores/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/inversores/active.svg",
  label: "Inversores",
  to: `${adminRoot}/menu`,
  subs: [{
...
{
  id: "asesores",
  icon: rutaImage+"/assets/img/buttons/asesores/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/asesores/active.svg",
  label: "Asesores",
  to: `${adminRoot}/blank-page`
},
{
  id: "proveedores",
  icon: rutaImage+"/assets/img/buttons/proveedores/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/proveedores/active.svg",
  label: "Proveedores",
...
{
  id: "fuentes",
  icon: rutaImage+"/assets/img/buttons/fuentes/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/fuentes/active.svg",
  label: "Fuentes",
  to: "https://piaf-vue-docs.coloredstrategies.com/",
  newWindow: true
},
{
  id: "api",
  icon: rutaImage+"/assets/img/buttons/API/default.svg",
  iconActive: rutaImage+"/assets/img/buttons/API/active.svg",
  label: "API",
  to: "https://piaf-vue-docs.coloredstrategies.com/",
  newWindow: true
}
